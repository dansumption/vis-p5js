class Glitch {
        ...
        shiftLine(srcImg) {
                ...
                offsetX =
                  this.channelLen *
                  this.processing.floor(this.processing.random(-40, 40));
        ...
        getRandomRectImg(srcImg) {
                ...
                let rectH;
                let destImg;
                startX = this.processing.floor(this.processing.random(0, srcImg.width - 30));
                startY = this.processing.floor(this.processing.random(0, srcImg.height - 50));
                rectW = this.processing.floor(this.processing.random(30, srcImg.width - startX));
        ...
        show(layer) {
                ...
                if (!this.throughFlag) {
                        layer.push();
                        layer.translate((this.processing.width - this.imgOrigin.width) / 2, (this.processing.height - this.imgOrigin.height) / 2);
                        layer.image(this.imgOrigin, 0, 0);
                        layer.pop();
                        return;
                }
                ...
                this.scatImgs.forEach(obj => {
                        ...
                        if (obj.img) {
                                layer.image(obj.img, 0, 0, this.processing.width, this.processing.height);
                        }
                });
        }
